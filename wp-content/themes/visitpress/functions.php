 ...
 *  
*/    
$visitpress_lang = get_bloginfo( 'language' );		//Blog Language
$visitpress_themename = "VisitPress";									//Theme Name
$visitpress_themever = "1.0.5";										//Theme version
...
if ( $visitpress_lang=="cs-CZ" )
$visitpress_be_path = get_template_directory() . '/functions/be/cz/';									//BackEnd Path
else $visitpress_be_path = get_template_directory() . '/functions/be/';									//BackEnd Path
